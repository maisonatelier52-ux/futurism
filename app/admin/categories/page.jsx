...
import {
  getCategories, saveCategory, deleteCategory, uploadImage,
...
export default function CategoriesPage() {
  ...
  async function handleBannerImage(e) {
    ...
    try {
      ...
      setBannerBase64(url); // holds the Cloudinary URL (see note on state declaration above)
  ...
  function validate() {
    ...
    if (!formData.bannerImageAlt.trim())  e.bannerImageAlt  = "Banner alt text is required.";
    ...
    if (!bannerPreview)                   e.bannerImage     = "Banner image is required.";
    setFormErrors(e);
  ...
  async function handleSubmit(e) {
    ...
    try {
      const payload = {
        ...formData,
        bannerImage: bannerBase64 || (editingCategory?.bannerImage ?? ""),
            ...
            <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
              ...
              <form onSubmit={handleSubmit} className="px-5 sm:px-6 pb-6 pt-5 space-y-6">
                ...
                <FormSection title="Banner Image">
                  <p className="text-[11.5px] text-ink-400 -mt-1">Only .webp · Under 300 KB · Stored locally</p>
                  ...
                  <div className="mt-3">
                    <FormField label="Banner Alt Text" required error={formErrors.bannerImageAlt}>
                      <input
                        type="text"
                ...
                <div className="flex gap-3 pt-1">
                  ...
                  <button
                    ...
                    className="flex-1 py-2.5 bg-primary text-black rounded-lg hover:bg-primary/90 transition-all disabled:opacity-50 cursor-pointer font-semibold text-sm flex items-center justify-center gap-2"
                  >
                    <Save size={14} />
                    {uploadingBanner ? "Uploading image…" : saving ? "Saving…" : editingCategory ? "Update" : "Save Category"}
                  </button>
                </div>
              </form>
            </div>
    ...
    <div className="bg-white border border-border rounded-2xl overflow-hidden hover:border-primary/30 hover:shadow-md transition-all duration-200">
      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="flex flex-wrap gap-2 pt-3 border-t border-border mt-2">
          ...
          {category.seoTitle && (
            <span className="text-blue-500 text-[11px]">· Has SEO</span>
          )}
        </div>
      </div>
    </div>
