        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
          ...
          <div className="flex items-center gap-6 md:pt-3">
            {tabs.subcategories.map((sub, i) => (
              <a key={sub} href="#" className={`font-[family-name:var(--font-scale)] text-xs font-semibold uppercase tracking-widest ${i === 0 ? "text-gray-900" : "text-gray-500"} hover:text-red-600`}>
                {sub}
              </a>
            ))}
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-8 border-t border-gray-200 mt-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-3">
            ...
            <a href="#" className="block text-center mt-4 border border-gray-300 rounded-lg py-2.5 font-[family-name:var(--font-scale)] text-xs font-bold uppercase tracking-widest text-gray-700 hover:bg-gray-50">
          ...
          <div className="lg:col-span-9">
            ...
            <a href={featured.href || "#"} className="group grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
              ...
              <div className="flex flex-col justify-center">
                ...
                <p className="font-[family-name:var(--font-owners-text)] text-xs text-gray-500 mt-3">By {featured.author}</p>
              </div>
            </a>
